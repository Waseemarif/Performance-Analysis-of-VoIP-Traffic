...
# creating our udp agents and attaching it to the correct nodes

set udp0 [new Agent/UDP]
$ns attach-agent $U0 $udp0
$udp0 set fid_ 1
...
# connecting sinks to the udp agents
...
#setting up the time for when the simulation start and when certain background traffics turn on and off and when the users begin to speak
